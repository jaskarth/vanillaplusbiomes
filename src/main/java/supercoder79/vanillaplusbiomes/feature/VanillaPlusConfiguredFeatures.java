...
public class VanillaPlusConfiguredFeatures {
                    ...
                    ImmutableList.of(
                            ...
                            Feature.TREE.configure(
                                    new TreeFeatureConfig.Builder(
                                            ...
                                            new DecayingDarkOakFoliagePlacer(UniformIntDistribution.of(-1), UniformIntDistribution.of(0)),
                    ...
                    ImmutableList.of(
                            ...
                            Feature.TREE.configure(
                                    new TreeFeatureConfig.Builder(
                                            new SimpleBlockStateProvider(Blocks.DARK_OAK_LOG.getDefaultState()),
                                            new SimpleBlockStateProvider(Blocks.DARK_OAK_LEAVES.getDefaultState()),
                                            new DarkOakFoliagePlacer(UniformIntDistribution.of(0, 1), UniformIntDistribution.of(0)),
                                            new AncientTrunkPlacer(8, 8, 8),
                                            new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()))
                                            .maxWaterDepth(Integer.MAX_VALUE)
    ...
    public static final ConfiguredFeature<?, ?> TALL_SPRUCE = Feature.TREE.configure(
            new TreeFeatureConfig.Builder(
                    new SimpleBlockStateProvider(Blocks.SPRUCE_LOG.getDefaultState()),
                    new SimpleBlockStateProvider(Blocks.SPRUCE_LEAVES.getDefaultState()),
                    new SpruceFoliagePlacer(UniformIntDistribution.of(2, 1), UniformIntDistribution.of(0, 3), UniformIntDistribution.of(1, 1)),
                    new StraightTrunkPlacer(10, 4, 4),
                    new TwoLayersFeatureSize(2, 0, 2)).ignoreVines().build())
            .decorate(Decorator.HEIGHTMAP.configure(NopeDecoratorConfig.INSTANCE))
            .spreadHorizontally()
    ...
    public static final ConfiguredFeature<?, ?> FEN_PINE = Feature.TREE.configure(
            new TreeFeatureConfig.Builder(
                    new SimpleBlockStateProvider(Blocks.SPRUCE_LOG.getDefaultState()),
                    new SimpleBlockStateProvider(Blocks.SPRUCE_LEAVES.getDefaultState()),
                    new PineFoliagePlacer(UniformIntDistribution.of(1), UniformIntDistribution.of(1), UniformIntDistribution.of(2, 1)),
                    new StraightTrunkPlacer(6, 4, 0),
                    new TwoLayersFeatureSize(2, 0, 2)).ignoreVines().maxWaterDepth(3).build())
            .decorate(Decorator.HEIGHTMAP.configure(NopeDecoratorConfig.INSTANCE))
            .spreadHorizontally()
            .decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(1, 0.1f, 1)));
    ...
    public static final ConfiguredFeature<?, ?> FEN_SPRUCE = Feature.TREE.configure(
            new TreeFeatureConfig.Builder(
                    new SimpleBlockStateProvider(Blocks.SPRUCE_LOG.getDefaultState()),
                    new SimpleBlockStateProvider(Blocks.SPRUCE_LEAVES.getDefaultState()),
                    new SpruceFoliagePlacer(UniformIntDistribution.of(1), UniformIntDistribution.of(1), UniformIntDistribution.of(2, 1)),
                    new StraightTrunkPlacer(6, 4, 0),
                    new TwoLayersFeatureSize(2, 0, 2)).ignoreVines().maxWaterDepth(3).build())
            .decorate(Decorator.HEIGHTMAP.configure(NopeDecoratorConfig.INSTANCE))
            .spreadHorizontally()
    ...
    private static final TreeFeatureConfig SWAMP_TREE = (new TreeFeatureConfig.Builder(
            ...
            new StraightTrunkPlacer(5, 3, 0), new TwoLayersFeatureSize(1, 0, 1)))
            .maxWaterDepth(1)
