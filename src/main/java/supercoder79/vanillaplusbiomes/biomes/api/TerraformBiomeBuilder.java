...
public final class TerraformBiomeBuilder extends BuilderBiomeSettings {
	...
	private final ArrayList<supercoder79.vanillaplusbiomes.biomes.api.FeatureEntry> features = new ArrayList<>();
	...
	public Biome build() {
		...
		for (supercoder79.vanillaplusbiomes.biomes.api.FeatureEntry feature : features) {
	...
	public TerraformBiomeBuilder addFeature(GenerationStep.Feature step, ConfiguredFeature feature) {
		this.features.add(new supercoder79.vanillaplusbiomes.biomes.api.FeatureEntry(step, feature));
		return this;
	}
